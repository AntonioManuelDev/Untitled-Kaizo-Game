...
namespace SupanthaPaul
{
	public class PlayerController : MonoBehaviour
	{
		...
		void Start()
		{
            ...
            sounds = Instantiate(Resources.Load("SoundEffects",typeof(GameObject))) as GameObject;
			dashSound = Resources.Load<AudioClip>("swing-whoosh-110410");
			jumpSound = Resources.Load<AudioClip>("fast-simple-chop-5-6270");
		}
		...
		void playSoundJump()
		{
			sounds.GetComponent<AudioSource>().PlayOneShot(jumpSound);
		}
        void playSoundDash()
        {
            sounds.GetComponent<AudioSource>().PlayOneShot(dashSound);
        }
    }
}
